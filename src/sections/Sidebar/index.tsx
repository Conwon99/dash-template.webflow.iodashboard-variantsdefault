...
import { SidebarMenuItem } from "@/sections/Sidebar/components/SidebarMenuItem";
import { SidebarDivider } from "@/sections/Sidebar/components/SidebarDivider";
    ...
    >
      <div className="fixed bg-white border-b-slate-900 border-l-slate-900 border-r-slate-200 border-t-slate-900 box-border caret-transparent flex flex-col h-[1000px] translate-x-[-250px] w-[250px] z-[500] overflow-auto border-r left-[0%] inset-y-[0%] md:transform-none">
        ...
        <div className="relative box-border caret-transparent text-left z-[900] mr-px">
          <SidebarMenuItem
            iconUrl="https://c.animaapp.com/mi8vbwr5PkuurH/assets/6058703e748ec21a46ed3b4e_Account.svg"
            label="Dashboards"
            isActive={true}
          />
        </div>
        ...
        <SidebarMenuItem
          iconUrl="https://c.animaapp.com/mi8vbwr5PkuurH/assets/6058703e6745533389ec44a9_CRM.svg"
          label="CRM"
        />
        <SidebarDivider />
        <SidebarMenuItem
          iconUrl="https://c.animaapp.com/mi8vbwr5PkuurH/assets/605882df7148e50e7c81f2a2_tool.svg"
          label="Utilities"
        />
        <SidebarMenuItem
          iconUrl="https://c.animaapp.com/mi8vbwr5PkuurH/assets/605882e02b9b3466f904de5b_unlock.svg"
          label="Authentication"
        />
        <SidebarMenuItem
          iconUrl="https://c.animaapp.com/mi8vbwr5PkuurH/assets/605882d1ba1d74c3077fed5a_edit.svg"
          label="Template"
        />
      </div>
